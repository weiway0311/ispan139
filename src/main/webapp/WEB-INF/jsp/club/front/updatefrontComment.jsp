...
<!--                     <div class="col-lg-5 d-none d-lg-block bg-register-image"></div> -->
                    <div class="col-lg-12">
						...
						<br>
						<form action="/club/CommentfrontUpdateById" method="post">
							<br>
							<input type="hidden" name="clubId" value="${comm.clubId}" />
							<input type="hidden" name="readerId" value="${comm.readerId}" />
							<input type="hidden" name="commentId" value="${comm.commentId}" />
							文章內容:<textarea id="editor" name="articleBody">${comm.articleBody}</textarea><br>
							<%--創建時間:<input name="clubDate" value="${comm.clubDate}" required><br> --%>
