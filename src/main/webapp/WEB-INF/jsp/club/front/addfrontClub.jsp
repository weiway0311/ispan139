...
<!--                     <div class="col-lg-5 d-none d-lg-block bg-register-image"></div> -->
                    <div class="col-lg-12">
                        <div class="p-5">
                        	<h3>新建討論</h3>
						<input  type="button" value="返回討論區" class="btn btn-primary" id="back" onclick="back()" class="btn btn-outline-primary">
						<br>
						<form action="/club/clubfrontAddController" method="post">
						<br>	
						<input type="hidden" name="readerId" value="${userDetail.readerId}" />
							...
							標題名稱:<br><textarea cols="40" rows="2" name="articleHeader" id="articleHeader" required></textarea><br>
						...
						<br>
						<button class="btn btn-secondary" onclick="oneTape()">一鍵輸入</button>
                            </div>
                        </div>
                    </div>
                </div>
