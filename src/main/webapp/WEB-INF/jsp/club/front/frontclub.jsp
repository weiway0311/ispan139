...
<!-- ===================== 03. 前台套版 Footer end ===================== -->
	...
	function loadPage(indexPage){
	    $.ajax({
	       type:'post',
	       url:'/club/clubfrontPage/' + indexPage,
	       dataType:'json',
	       ...
	       success: function(data){
	          ...
	          if(data==null){
	             ...
	             table.append("<thead class='table-dark'><tr><th>文章編號</th><th>主題</th><th>預覽圖片</th><th>標題名稱</th><th>文章篇數</th><th>創建時間</th></tr></thead>");
	             ...
	             $.each(data, function(i,n){
	                  var tr = "<tbody><tr>" 
						...
						+ "<td><a href='/club/CommentfrontSearchById?id="+ n[0].clubId +"'>" + n[0].articleHeader + "</a></td>" 
						+ "<td><p>" + n[1] + "則</p></td>" 
						+ "<td><p>" + n[0].clubDate + "</p></td>" 
// 						+ "<td>"  
// 							+ `<button type="button" class="btn btn-warning" style="color:white" data-dismiss="modal" onclick="location.href='/club/clubfrontSearchById?id=\${n[0].clubId}'"><i class="fa" style="color:white">&#xf044;</i>修改</button>`
// 							+ "<span> | </span>"
// 							+ `<button type="button" class="btn btn-danger" style="color:white" data-dismiss="modal" onclick="location.href='/club/clubfrontDeleteById?id=\${n[0].clubId}'"><i class="fa" aria-hidden="true">&#xf2ed;</i>刪除</button>`
// 						+ "</td>" 
		          ...
		          if(data==null){
		             ...
		             $.each(data, function(i,n){
		                  var tr = "<tbody><tr>" 
	                       ...
	                       + "<td><p>" + n[0].clubDate + "</p></td>" 
// 	                       + "<td>" 
// 	                       	  + `<button type="button" class="btn btn-warning" data-dismiss="modal" onclick="location.href='/club/clubfrontSearchById?id=\${n.clubId}'"><i class="fa" style="color:white">&#xf044;</i>修改</button>`
// 	                          + "<span> | </span>"
// 	                          + `<button type="button" class="btn btn-danger" data-dismiss="modal" onclick="location.href='/club/clubfrontDeleteById?id=\${n.clubId}'"><i class="fa" aria-hidden="true">&#xf2ed;</i>刪除</button>`
// 				 		   + "</td>" 
	...
	function add(readerId){
		if(readerId == null){
			...
			location.href = "/club/addfrontClub.controller";
		}
