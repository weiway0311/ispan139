			...
			<div class="row">
				<div class="col-lg-12">
					<div class="p-5">
						...
						<br>
						<form action="/club/clubUpdateById" method="post">
						<br>
						<input type="hidden" name="clubId" value="${club.clubId}" />
						<input type="hidden" name="readerId" value="${club.readerId}" />
							主題:<select name="clubClass">
									<option value="討論區">討論區</option>
									<option value="心得區">心得區</option>
									<option value="分享區">分享區</option>
								</select><br>
							標題名稱:<br><textarea cols="40" rows="2" name="articleHeader" id="textarea1" required>${club.articleHeader}</textarea><br>
							文章內容:<textarea id="editor" name="articleBody">${club.articleBody}</textarea><br>
							<%--創建時間:<input name="clubDate" value="${club.clubDate}" required><br> --%>
