  ...
  <el-form-item>
    ...
    <el-button @click="dialogVisibleForUpdate=false">返回</el-button>
      ...
      <el-button type="danger" icon="el-icon-delete" circle name="todo" id="del" v-on:click="optDelete(scope.$index, scope.row)"></el-button>	<!-- delete -->
			...
			<!-- 分頁開始 -->
		<div class="block">
    <span class="demonstration">共{{Math.ceil(bookTotalPages / 2 )}}頁</span>
    <el-pagination
      background
	...
	new Vue ({
		...
		methods: {
		    ...
		    mounted:function(){
		        ...
		        console.log(typeof _this.tableData);
				console.log(typeof _this.bookTotalPages);
				console.log(_this.bookTotalPages);
				console.log(typeof _this.bookTotalElements);
				console.log(_this.bookTotalElements);
