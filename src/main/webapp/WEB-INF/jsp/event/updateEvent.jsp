...
<!--                             </div> -->
                            ...
                            <!-- 修改基本資料 -->
                            <form class="user" method='post' action='/updateevent' id="updateInfo">
                                <input type="hidden" name="eventId" id="eventId" value="${event.eventId}">
                                <hr>
                            	<div class="form-group">
                            		<label>活動名稱：</label>
                                    <input type="text" name="eventName" id="eventName" class="form-control" value="${event.eventName}">
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    	<label>活動日期：</label>
                                        <input type="date" name="eventDate" id="eventDate" class="form-control" value="${event.getEventDate()}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    	<label>活動地點：</label>
                                        <input type="text" name="eventPlace" id="eventPlace" class="form-control" value="${event.eventPlace}">
                                    </div>
                                    <div class="col-sm-6">
                                    	<label>活動人數：</label>
                                    	<input type="number" name="eventNumber" id="eventNumber" class="form-control" value="${event.eventNumber}">
                                    </div>
                                </div>
                                <div class="form-group">
                                	<label>活動簡介：</label>
<%--                                     <input type="text" name="eventBio" id="eventBio" class="form-control" value="${event.eventBio}"> --%>
                                    <textarea type="text" name="eventBio" id="eventBio" class="form-control" rows="" cols="" style="height:200px;">${event.eventBio}</textarea>
                                </div>
                                <input class="btn btn-primary btn-block" type="submit" align="center" value="確認修改"/>
                                <button class="btn btn-warning btn-block" type="button" onclick="location.href='http://localhost:8080/eventDetail/${event.eventId}'" align="center">返回</button>
                            </form>
                            <hr>
                            <div align="right">
