...
<!-- 				<div class="sidebar-brand-text mx-3">SWAPOOKS</div> -->
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseClubs" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
							href="http://localhost:8080/club/clubmain.controller">查詢全部貼文</a>
						<a class="collapse-item"
							href="http://localhost:8080/club/addClub.controller">新增貼文</a>
					</div>
				</div></li>
	...
	<div class="container">
		...
		<nav class="navbar navbar-light">
			<div class="container-fluid" style="padding-left: 0px">
				...
				<form class="d-flex" action="/order/searchorderbyid.controller" method="get">
					<input class="form-control me-2" style="width: 70%" type="search" name="id" placeholder="請輸入訂單編號...">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active" aria-current="page">全部</a></li>
			<li class="nav-item"><a class="nav-link" href="#">處理中</a></li>
			<li class="nav-item"><a class="nav-link" href="#">已完成</a></li>
			<li class="nav-item"><a class="nav-link" href="#">已取消</a></li>
		</ul>
		<div class="mb-3">
			<form action="/booksplattform/OrdersUpdateById2" method="post">
				...
				<table cellspacing="0" class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td>${order.custId}</td>
							<td>${order.total}</td>
							<td><a class="btn btn-outline-success" href="gotodetails.controller?id=${order.oId}">詳情</a>
						</tr>
					</tbody>
				</table>
		</div>
		<div align="right">
		<input class="btn btn-outline-primary" type="button" value="返回" id="return">
		</div>
		<script>
