<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" import="com.booksplattform.model.order.Details" import="java.util.*"%>
	...
	<!-- =================== 04. 套版 Top & Side bar end =================== -->
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h3 class="col-sm-6 mb-3 mb-sm-0 font-weight-bold">訂單詳情 | ${details.oId}</h3>
						</div>
						<div class="card-body">
